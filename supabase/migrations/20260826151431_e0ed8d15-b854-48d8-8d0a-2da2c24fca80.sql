...
ALTER TABLE public.programacoes ADD CONSTRAINT programacoes_tipo_check CHECK (tipo IN (
  ...
  'registro_encaminhamentos_internos','registro_formacao_coletiva','registro_planejamento_conjunto',
  'encontro_microciclos_recomposicao',
  'visita_tecnica_alfabetizacao_redes','visita_tecnica_tarl','visita_tecnica_alfabetizacao',
  'reuniao_acomp_alfabetizacao','visita_tecnica_secretaria_sme','acompanhamento_aula','visita'
));
...
VALUES ('registro_planejamento_conjunto', ARRAY['escolas']::programa_type[], 0)
