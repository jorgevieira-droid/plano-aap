...
ALTER TABLE public.programacoes ADD CONSTRAINT programacoes_tipo_check CHECK (tipo IN (
  ...
  'registro_encaminhamentos_internos','registro_formacao_coletiva','encontro_microciclos_recomposicao',
...
VALUES ('registro_formacao_coletiva', ARRAY['escolas']::programa_type[], 0)
