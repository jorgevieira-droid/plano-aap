...
export const ACAO_TYPE_INFO: Record<AcaoTipo, AcaoTypeInfo> = {
  ...
  registro_consultoria_pedagogica: { tipo: 'registro_consultoria_pedagogica', label: 'Apoio Presencial com a Coordenação',                 icon: ClipboardList },
  registro_apoio_presencial:       { tipo: 'registro_apoio_presencial',       label: 'Apoio Presencial',                                   icon: ClipboardList },
  ...
  registro_formacao_coletiva:      { tipo: 'registro_formacao_coletiva',      label: 'Formação Coletiva',                                  icon: ClipboardList },
