...
const styles = {
  ...
  ratingRow: { display: 'flex', gap: 14, marginTop: 6, flexWrap: 'wrap' as const } as React.CSSProperties,
...
const RUBRICA = [
  { titulo: '0 — Não realizado', desc: 'Não foi feito ou não há qualquer evidência.', cor: '#c0392b' },
  { titulo: '1 — Inicial', desc: 'Iniciado, mas sem consistência ou sem evidência clara.', cor: '#e67e22' },
  { titulo: '2 — Parcial', desc: 'Realizado, mas incompleto, superficial ou irregular.', cor: '#f1c40f' },
  { titulo: '3 — Consolidado', desc: 'Realizado de forma completa, estruturada e com evidências claras.', cor: '#27ae60' },
];
...
const RatingValue: React.FC<{ value: any; min: number; max: number }> = ({ value, min, max }) => {
  const opts: number[] = [];
