  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      form.reset({
        ...
        encA_pontos_fortes: existing.encA_pontos_fortes || '',
        encA_aspectos_fortalecer: existing.encA_aspectos_fortalecer || '',
        encA_encaminhamentos: existing.encA_encaminhamentos || '',
        encB_pontos_fortes: existing.encB_pontos_fortes || '',
        encB_aspectos_fortalecer: existing.encB_aspectos_fortalecer || '',
        encB_encaminhamentos: existing.encB_encaminhamentos || '',
        encC_pontos_fortes: existing.encC_pontos_fortes || '',
        encC_aspectos_fortalecer: existing.encC_aspectos_fortalecer || '',
        encC_encaminhamentos: existing.encC_encaminhamentos || '',
