        ...
        <div className="space-y-4 flex-1 overflow-hidden flex flex-col">
          ...
          <div className="bg-muted/50 rounded-lg p-4 text-sm space-y-3">
            ...
            <div className="flex items-start gap-2 text-xs text-muted-foreground bg-warning/10 border border-warning/20 rounded p-2">
              ...
              <span>
                Tipos como <strong>Observação de Aula</strong>, <strong>Visitas Técnicas - Microciclos</strong>, <strong>Encontros REDES</strong>, <strong>Autoavaliação</strong> e <strong>Lista de Presença</strong> não podem ser importados em lote pois requerem preenchimento de instrumento/formulário no momento do registro.
              </span>
            </div>
          </div>
